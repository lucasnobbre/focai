<aside>
<?php
        $args = array( 'showposts' => 1, 'offset'=> 1, 'category_name' => 'moda', 'offset' => '0');
...
<div class="sidebar-img"><a href="<?php the_permalink()?>" title="<?php the_title_attribute(); ?>" rel="bookmark"><?php the_post_thumbnail('medium'); ?></a></div>
